...
app.post('/data', function(req,res){
    ...
    WATSON_KEY = "j_SGlFu96yzlU93WwjM9ujX1JvBQrkPAm4NMgJiAfmzX";  
    WATSON_CLASSIFIER = "DefaultCustomModel_1658501629";
    }else if(req.body.classifier == "Aang"){
            WATSON_KEY = "S8c69N2-ZghAUtx9Qgf1djCs8knydOOuKjRMiIuUL0if";  
    WATSON_CLASSIFIER = "Aang_147717128";
    }else if(req.body.classifier == "Toph"){
            WATSON_KEY = "XuHOSkxFC1YHgBosTWV0jAhm0cJKf4-zkk7mENfphYOD";  
    WATSON_CLASSIFIER = "Toph_1608310328";
    }else if(req.body.classifier == "Zuko"){
            WATSON_KEY = "GfhmgWBQcZ3Qy2Hf2078Yp7Qomq3-PO8rAK3TTxl28lf";  
    WATSON_CLASSIFIER = "DefaultCustomModel_392192910";
    }
    visual_recognition = new VisualRecognitionV3({
    iam_apikey: WATSON_KEY,
    version: '2016-05-19'
});
    console.log(WATSON_KEY)
    console.log(WATSON_CLASSIFIER)
    res.redirect('/classifier')
})

app.get('/classifier', function(req, res){
    res.sendFile(__dirname + '/public/classifier.html')
})
